...
public class ItemServiceImpl implements ItemService {
    ...
    private ItemStockDO convertItemStockDOFromItemStcokModel(ItemModel itemModel){
        if (itemModel == null){
            return null;
        }
    ...
    public ItemModel createItem(ItemModel itemModel) throws BusinessException {
        //校验入参
        ValidationResults results = validator.validate(itemModel);
        ...
        ItemStockDO itemStockDO = this.convertItemStockDOFromItemStcokModel(itemModel);
